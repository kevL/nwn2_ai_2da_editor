...
{
	/// <summary>
	/// A parent-class inherited by <c><see cref="tabcontrol_Spells"/></c>,
	/// <c><see cref="tabcontrol_Racial"/></c>, and
	/// <c><see cref="tabcontrol_Classes"/></c>. This allows the
	...
	/// <c>tabcontrol_*</c> designers will fuck up. thanks.
	/// 
	/// 
	/// Do not turn this into an <c>interface</c> either since
	/// <c>tabcontrol_Spells</c> does not override the last two functs. (read:
