...
namespace nwn2_ai_2da_editor
{
	partial class MainForm
	{
		...
		TabPage page_EffectWeight;
		TabPage page_EffectTypes;
		...
		Button SpellInfo_reset;
		Button TargetInfo_reset;
		Button EffectWeight_reset;
		Button EffectTypes_reset;
		Button DamageInfo_reset;
		Button SaveType_reset;
		Button SaveDCType_reset;
		Label f2;
		Label f1;
		Button apply;
		...
		RadioButton st_Impact2rb_effectonly;
		ComboBox cbo_st_Specific;
		GroupBox st_Immunity1Grp;
		ComboBox cbo_st_Immunity1;
		...
		TabControl cols_HenchRacial;
		TabPage page_RacialFlags;
		TabPage page_RacialFeat1;
		TabPage page_RacialFeat2;
		TabPage page_RacialFeat3;
		TabPage page_RacialFeat4;
		TabPage page_RacialFeat5;
		TabControl cols_HenchClasses;
		TabPage page_ClassFlags;
		TabPage page_ClassFeat1;
		TabPage page_ClassFeat2;
		TabPage page_ClassFeat3;
		TabPage page_ClassFeat4;
		TabPage page_ClassFeat5;
		TabPage page_ClassFeat6;
		TabPage page_ClassFeat7;
		TabPage page_ClassFeat8;
		TabPage page_ClassFeat9;
		TabPage page_ClassFeat10;
		TabPage page_ClassFeat11;
		Label rf_bin;
		Label rf_hex;
		Button rf_Clear;
		...
		Button ClassFeat11_reset;
		Label rf_infoversion;
		Label rf_infoversion_lbl;
		...
		Label cf_infoversion;
		Label cf_infoversion_lbl;
		...
		Label si_ChildLabel1;
		Label si_infoversion;
		Label si_infoversion_lbl;
