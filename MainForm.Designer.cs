...
namespace nwn2_ai_2da_editor
{
	partial class MainForm
	{
		...
		private TabPage page_EffectWeight;
		private TabPage page_EffectTypes;
		private TabPage page_DamageInfo;
		private TabPage page_SaveType;
		private TabPage page_SaveDCType;
		private TreeView Tree;
		private SplitContainer splitContainer1;
		private ToolStripMenuItem Open;
		private TextBox EffectWeight_text;
		private Button SpellInfo_reset;
		private Button TargetInfo_reset;
		private Button EffectWeight_reset;
		private Button EffectTypes_reset;
		private Button DamageInfo_reset;
		private Button SaveType_reset;
		private Button SaveDCType_reset;
		private Label f2;
		private Label f1;
		private Button apply;
		private Label savedctype_label;
		private GroupBox dc_WeaponBonusGrp;
		private GroupBox dc_SaveDCGrp;
		private ComboBox cbo_dc_SaveDC;
		private TextBox SaveDCType_text;
		private Button savedc_dn;
		private Button savedc_up;
		private Label savedc_adjustor_info;
		private Label savedc_info;
		private ComboBox cbo_dc_WeaponBonus;
		private TextBox SaveType_text;
		private CheckBox savedc_ac3;
		private CheckBox savedc_ac2;
		private CheckBox savedc_ac1;
		private GroupBox dc_ArmorCheckGrp;
		private Label armorcheck_info;
		private GroupBox st_SpecificGrp;
		private GroupBox st_FlagsGrp;
		private CheckBox st_SpellResistance;
		private CheckBox st_MindAffecting;
		private CheckBox st_AffectsFriendlies;
		private CheckBox st_TouchRanged;
		private CheckBox st_NotCaster;
		private CheckBox st_TouchMelee;
		private GroupBox st_Save2Grp;
		private GroupBox st_Save1Grp;
		private GroupBox st_Impact2Grp;
		private GroupBox st_Impact1Grp;
		private RadioButton st_Save1rb_none;
		private RadioButton st_Save2rb_will;
		private RadioButton st_Save2rb_refl;
		private RadioButton st_Save2rb_fort;
		private RadioButton st_Save2rb_none;
		private RadioButton st_Save1rb_will;
		private RadioButton st_Save1rb_refl;
		private RadioButton st_Save1rb_fort;
		private RadioButton st_Impact1rb_damagehalf;
		private RadioButton st_Impact1rb_effectonly;
		private RadioButton st_Impact1rb_damageevasion;
		private RadioButton st_Impact1rb_effectdamage;
		private RadioButton st_Impact2rb_damageevasion;
		private RadioButton st_Impact2rb_effectdamage;
		private RadioButton st_Impact2rb_damagehalf;
		private RadioButton st_Impact2rb_effectonly;
		private ComboBox cbo_st_Specific;
		private GroupBox st_Immunity1Grp;
		private ComboBox cbo_st_Immunity1;
		private GroupBox st_AcBonusGrp;
		private ComboBox cbo_st_AcBonus;
		private GroupBox st_TargetRestrictionGrp;
		private ComboBox cbo_st_TargetRestriction;
		private GroupBox st_Immunity2Grp;
		private ComboBox cbo_st_Immunity2;
		private ToolStripMenuItem edit;
		private ToolStripMenuItem Copy_decimal;
		private ToolStripMenuItem Copy_hexadecimal;
		private ToolStripMenuItem Copy_binary;
		private TextBox SaveType_bin;
		private TextBox SaveType_hex;
		private TextBox SaveDCType_bin;
		private TextBox SaveDCType_hex;
		private Button st_Clear;
		private Label st_bin;
		private Label st_hex;
		private Label dc_bin;
		private Label dc_hex;
		private Button dc_Clear;
		private Label si_bin;
		private Label si_hex;
		private Button si_Clear;
		private TextBox SpellInfo_bin;
		private TextBox SpellInfo_hex;
		private TextBox SpellInfo_text;
		private Label ti_bin;
		private Label ti_hex;
		private Button ti_Clear;
		private TextBox TargetInfo_bin;
		private TextBox TargetInfo_hex;
		private TextBox TargetInfo_text;
		private Button ew_Clear;
		private Label et_bin;
		private Label et_hex;
		private Button et_Clear;
		private TextBox EffectTypes_bin;
		private TextBox EffectTypes_hex;
		private TextBox EffectTypes_text;
		private Label di_bin;
		private Label di_hex;
		private Button di_Clear;
		private TextBox DamageInfo_bin;
		private TextBox DamageInfo_hex;
		private TextBox DamageInfo_text;
		private GroupBox si_SpelltypeGrp;
		private ComboBox cbo_si_Spelltype;
		private CheckBox si_LongDurBuff;
		private CheckBox si_MediumDurBuff;
		private CheckBox si_ShortDurBuff;
		private CheckBox si_HealOrCure;
		private CheckBox si_Unlimited;
		private CheckBox si_Concentration;
		private CheckBox si_Ignore;
		private CheckBox si_IsMaster;
		private GroupBox si_SpelllevelGrp;
		private ComboBox cbo_si_Spelllevel;
		private CheckBox si_ItemCast;
		private GroupBox si_FlagsGrp;
		private GroupBox et_BenEffectsGrp;
		private CheckBox et_AcIncrease;
		private CheckBox et_Regenerate;
		private CheckBox et_ImmunityNecromancy;
		private CheckBox et_SpellShield;
		private CheckBox et_SeeInvisible;
		private CheckBox et_AbilityIncrease;
		private CheckBox et_ElementalShield;
		private CheckBox et_GreaterInvisibility;
		private CheckBox et_Wildshape;
		private CheckBox et_TrueSeeing;
		private CheckBox et_Ultravision;
		private CheckBox et_Polymorph;
		private CheckBox et_Invisibility;
		private CheckBox et_Ethereal;
		private CheckBox et_AbsorbDamage;
		private CheckBox et_DamageIncrease;
		private CheckBox et_Concealment;
		private CheckBox et_SavingThrowIncrease;
		private CheckBox et_SpellAbsorption;
		private CheckBox et_Timestop;
		private CheckBox et_Sanctuary;
		private CheckBox et_TempHitpoints;
		private CheckBox et_Haste;
		private CheckBox et_DamageReduction;
		private CheckBox et_AttackIncrease;
		private Label si_hostile;
		private GroupBox et_DetEffectsGrp;
		private CheckBox et_AcDecrease;
		private CheckBox et_NegativeLevel;
		private CheckBox et_Death;
		private CheckBox et_SpeedDecrease;
		private CheckBox et_Petrify;
		private CheckBox et_Stun;
		private CheckBox et_SkillDecrease;
		private CheckBox et_AttackDecrease;
		private CheckBox et_DamageDecrease;
		private CheckBox et_AbilityDecrease;
		private CheckBox et_Slow;
		private CheckBox et_Silence;
		private CheckBox et_Disease;
		private CheckBox et_Poison;
		private CheckBox et_Daze;
		private CheckBox et_Dominate;
		private CheckBox et_Frighten;
		private CheckBox et_Confuse;
		private CheckBox et_Charm;
		private CheckBox et_Sleep;
		private CheckBox et_Curse;
		private CheckBox et_Blindness;
		private CheckBox et_Deafness;
		private CheckBox et_Paralyze;
		private CheckBox et_Entangle;
		private CheckBox et_CutsceneParalyze;
		private CheckBox et_Mesmerize;
		private CheckBox et_Dying;
		private CheckBox et_Knockdown;
		private CheckBox et_SavingThrowDecrease;
		private GroupBox si_ChildIDGrp;
		private TextBox si_Child5;
		private TextBox si_Child4;
		private TextBox si_Child3;
		private TextBox si_Child2;
		private TextBox si_Child1;
		private ToolStripMenuItem options;
		private ToolStripMenuItem setCoreAIver;
		private GroupBox ti_FlagsGrp;
		private CheckBox ti_Regular;
		private CheckBox ti_Necromancy;
		private CheckBox ti_ScaledEffect;
		private CheckBox ti_PersistentAoe;
		private CheckBox ti_RangedSelectedArea;
		private CheckBox ti_SeenRequired;
		private CheckBox ti_SecondaryHalfDamage;
		private CheckBox ti_SecondaryTargets;
		private CheckBox ti_MissileTargets;
		private CheckBox ti_CheckCount;
		private CheckBox ti_ShapeLoop;
		private GroupBox ti_RadiusGrp;
		private GroupBox ti_RangeGrp;
		private ComboBox cbo_ti_Range;
		private GroupBox ti_ShapeGrp;
		private ComboBox cbo_ti_Shape;
		private TextBox ti_Radius;
		private GroupBox di_DispelTypesGrp;
		private CheckBox di_Breach;
		private CheckBox di_Resist;
		private CheckBox di_Dispel;
		private GroupBox di_DetrimentalGrp;
		private GroupBox di_BeneficialGrp;
		private GroupBox di_BenLeveltypeGrp;
		private ComboBox cbo_di_BenLeveltype;
		private GroupBox di_DetDamagebaseGrp;
		private ComboBox cbo_di_DetDamagebase;
		private GroupBox di_DetLeveltypeGrp;
		private ComboBox cbo_di_DetLeveltype;
		private GroupBox di_BenPowerbaseGrp;
		private ComboBox cbo_di_BenPowerbase;
		private GroupBox di_DetFixedCountGrp;
		private TextBox di_DetFixedcount;
		private Label di_lbl_FixedCountPlusOne;
		private GroupBox di_BenLeveldecreaseGrp;
		private TextBox di_BenLeveldecrease;
		private GroupBox di_BenLeveldivisorGrp;
		private TextBox di_BenLeveldivisor;
		private GroupBox di_BenLevellimitGrp;
		private TextBox di_BenLevellimit;
		private GroupBox di_BenPowerGrp;
		private TextBox di_BenPower;
		private GroupBox di_DetDamagetypeGrp;
		private GroupBox di_DetLeveldivisorGrp;
		private TextBox di_DetLeveldivisor;
		private GroupBox di_DetLevellimitGrp;
		private TextBox di_DetLevellimit;
		private GroupBox di_DetDamageGrp;
		private TextBox di_DetDamage;
		private CheckBox di_Bludgeoning;
		private CheckBox di_Sonic;
		private CheckBox di_Positive;
		private CheckBox di_Negative;
		private CheckBox di_Fire;
		private CheckBox di_Electrical;
		private CheckBox di_Divine;
		private CheckBox di_Cold;
		private CheckBox di_Acid;
		private CheckBox di_Magical;
		private CheckBox di_Slashing;
		private CheckBox di_Piercing;
		private ToolStripMenuItem Save;
		private ToolStripMenuItem Saveas;
		private ToolTip toolTip1;
		private Button btn_Search_d;
		private TextBox tb_Search;
		private Button btn_Search_u;
		private GroupBox st_ExclusiveGrp;
		private GroupBox st_Excl_DamagetypesGrp;
		private CheckBox st_Excl_Sonic;
		private CheckBox st_Excl_Positive;
		private CheckBox st_Excl_Negative;
		private CheckBox st_Excl_Fire;
		private CheckBox st_Excl_Electrical;
		private CheckBox st_Excl_Divine;
		private CheckBox st_Excl_Cold;
		private CheckBox st_Excl_Acid;
		private CheckBox st_Excl_Magical;
		private CheckBox st_Excl_Slashing;
		private CheckBox st_Excl_Piercing;
		private CheckBox st_Excl_Bludgeoning;
		private GroupBox st_Excl_WeightGrp;
		private TextBox st_Excl_Weight;
		private GroupBox st_Excl_FlagsGrp;
		private CheckBox st_Excl_General;
		private CheckBox st_Excl_Onlyone;
		private GroupBox st_DetrimentalGrp;
		private RadioButton st_Excl_rbResistance;
		private RadioButton st_Excl_rbImmunity;
		private ToolStripSeparator toolStripSeparator1;
		private ToolStripSeparator toolStripSeparator2;
		private ToolStripMenuItem gotoNextChanged;
		private ToolStripSeparator toolStripSeparator3;
		private ToolStripMenuItem help;
		private ToolStripMenuItem About;
		private TabControl cols_HenchRacial;
		private TabPage page_RacialFlags;
		private TabPage page_RacialFeat1;
		private TabPage page_RacialFeat2;
		private TabPage page_RacialFeat3;
		private TabPage page_RacialFeat4;
		private TabPage page_RacialFeat5;
		private TabControl cols_HenchClasses;
		private TabPage page_ClassFlags;
		private TabPage page_ClassFeat1;
		private TabPage page_ClassFeat2;
		private TabPage page_ClassFeat3;
		private TabPage page_ClassFeat4;
		private TabPage page_ClassFeat5;
		private TabPage page_ClassFeat6;
		private TabPage page_ClassFeat7;
		private TabPage page_ClassFeat8;
		private TabPage page_ClassFeat9;
		private TabPage page_ClassFeat10;
		private TabPage page_ClassFeat11;
		private Label rf_bin;
		private Label rf_hex;
		private Button rf_Clear;
		private TextBox RacialFlags_bin;
		private TextBox RacialFlags_hex;
		private TextBox RacialFlags_text;
		private Button RacialFlags_reset;
		private Label rf1_bin;
		private Label rf1_hex;
		private Button rf1_Clear;
		private TextBox RacialFeat1_bin;
		private TextBox RacialFeat1_hex;
		private TextBox RacialFeat1_text;
		private Button RacialFeat1_reset;
		private Label rf2_bin;
		private Label rf2_hex;
		private Button rf2_Clear;
		private TextBox RacialFeat2_bin;
		private TextBox RacialFeat2_hex;
		private TextBox RacialFeat2_text;
		private Button RacialFeat2_reset;
		private Label rf3_bin;
		private Label rf3_hex;
		private Button rf3_Clear;
		private TextBox RacialFeat3_bin;
		private TextBox RacialFeat3_hex;
		private TextBox RacialFeat3_text;
		private Button RacialFeat3_reset;
		private Label rf4_bin;
		private Label rf4_hex;
		private Button rf4_Clear;
		private TextBox RacialFeat4_bin;
		private TextBox RacialFeat4_hex;
		private TextBox RacialFeat4_text;
		private Button RacialFeat4_reset;
		private Label rf5_bin;
		private Label rf5_hex;
		private Button rf5_Clear;
		private TextBox RacialFeat5_bin;
		private TextBox RacialFeat5_hex;
		private TextBox RacialFeat5_text;
		private Button RacialFeat5_reset;
		private Label cf_bin;
		private Label cf_hex;
		private Button cf_Clear;
		private TextBox ClassFlags_bin;
		private TextBox ClassFlags_hex;
		private TextBox ClassFlags_text;
		private Button ClassFlags_reset;
		private Label cf1_bin;
		private Label cf1_hex;
		private Button cf1_Clear;
		private TextBox ClassFeat1_bin;
		private TextBox ClassFeat1_hex;
		private TextBox ClassFeat1_text;
		private Button ClassFeat1_reset;
		private Label cf2_bin;
		private Label cf2_hex;
		private Button cf2_Clear;
		private TextBox ClassFeat2_bin;
		private TextBox ClassFeat2_hex;
		private TextBox ClassFeat2_text;
		private Button ClassFeat2_reset;
		private Label cf3_bin;
		private Label cf3_hex;
		private Button cf3_Clear;
		private TextBox ClassFeat3_bin;
		private TextBox ClassFeat3_hex;
		private TextBox ClassFeat3_text;
		private Button ClassFeat3_reset;
		private Label cf4_bin;
		private Label cf4_hex;
		private Button cf4_Clear;
		private TextBox ClassFeat4_bin;
		private TextBox ClassFeat4_hex;
		private TextBox ClassFeat4_text;
		private Button ClassFeat4_reset;
		private Label cf5_bin;
		private Label cf5_hex;
		private Button cf5_Clear;
		private TextBox ClassFeat5_bin;
		private TextBox ClassFeat5_hex;
		private TextBox ClassFeat5_text;
		private Button ClassFeat5_reset;
		private Label cf6_bin;
		private Label cf6_hex;
		private Button cf6_Clear;
		private TextBox ClassFeat6_bin;
		private TextBox ClassFeat6_hex;
		private TextBox ClassFeat6_text;
		private Button ClassFeat6_reset;
		private Label cf7_bin;
		private Label cf7_hex;
		private Button cf7_Clear;
		private TextBox ClassFeat7_bin;
		private TextBox ClassFeat7_hex;
		private TextBox ClassFeat7_text;
		private Button ClassFeat7_reset;
		private Label cf8_bin;
		private Label cf8_hex;
		private Button cf8_Clear;
		private TextBox ClassFeat8_bin;
		private TextBox ClassFeat8_hex;
		private TextBox ClassFeat8_text;
		private Button ClassFeat8_reset;
		private Label cf9_bin;
		private Label cf9_hex;
		private Button cf9_Clear;
		private TextBox ClassFeat9_bin;
		private TextBox ClassFeat9_hex;
		private TextBox ClassFeat9_text;
		private Button ClassFeat9_reset;
		private Label cf10_bin;
		private Label cf10_hex;
		private Button cf10_Clear;
		private TextBox ClassFeat10_bin;
		private TextBox ClassFeat10_hex;
		private TextBox ClassFeat10_text;
		private Button ClassFeat10_reset;
		private Label cf11_bin;
		private Label cf11_hex;
		private Button cf11_Clear;
		private TextBox ClassFeat11_bin;
		private TextBox ClassFeat11_hex;
		private TextBox ClassFeat11_text;
		private Button ClassFeat11_reset;
		private Label rf_infoversion;
		private Label rf_infoversion_lbl;
		private CheckBox rf_HasFeatSpells;
		private TextBox rf1_SpellId;
		private TextBox rf1_FeatId;
		private CheckBox rf1_cheatCast;
		private Label rf1_spellId_label;
		private Label rf1_featId_label;
		private TextBox rf2_SpellId;
		private TextBox rf2_FeatId;
		private CheckBox rf2_cheatCast;
		private Label rf2_spellId_label;
		private Label rf2_featId_label;
		private TextBox rf3_SpellId;
		private TextBox rf3_FeatId;
		private CheckBox rf3_cheatCast;
		private Label rf3_spellId_label;
		private Label rf3_featId_label;
		private TextBox rf4_SpellId;
		private TextBox rf4_FeatId;
		private CheckBox rf4_cheatCast;
		private Label rf4_spellId_label;
		private Label rf4_featId_label;
		private TextBox rf5_SpellId;
		private TextBox rf5_FeatId;
		private CheckBox rf5_cheatCast;
		private Label rf5_spellId_label;
		private Label rf5_featId_label;
		private TextBox cf1_SpellId;
		private TextBox cf1_FeatId;
		private CheckBox cf1_cheatCast;
		private Label cf1_spellId_label;
		private Label cf1_featId_label;
		private TextBox cf2_SpellId;
		private TextBox cf2_FeatId;
		private CheckBox cf2_cheatCast;
		private Label cf2_spellId_label;
		private Label cf2_featId_label;
		private TextBox cf3_SpellId;
		private TextBox cf3_FeatId;
		private CheckBox cf3_cheatCast;
		private Label cf3_spellId_label;
		private Label cf3_featId_label;
		private TextBox cf4_SpellId;
		private TextBox cf4_FeatId;
		private CheckBox cf4_cheatCast;
		private Label cf4_spellId_label;
		private Label cf4_featId_label;
		private TextBox cf5_SpellId;
		private TextBox cf5_FeatId;
		private CheckBox cf5_cheatCast;
		private Label cf5_spellId_label;
		private Label cf5_featId_label;
		private TextBox cf6_SpellId;
		private TextBox cf6_FeatId;
		private CheckBox cf6_cheatCast;
		private Label cf6_spellId_label;
		private Label cf6_featId_label;
		private TextBox cf7_SpellId;
		private TextBox cf7_FeatId;
		private CheckBox cf7_cheatCast;
		private Label cf7_spellId_label;
		private Label cf7_featId_label;
		private TextBox cf8_SpellId;
		private TextBox cf8_FeatId;
		private CheckBox cf8_cheatCast;
		private Label cf8_spellId_label;
		private Label cf8_featId_label;
		private TextBox cf9_SpellId;
		private TextBox cf9_FeatId;
		private CheckBox cf9_cheatCast;
		private Label cf9_spellId_label;
		private Label cf9_featId_label;
		private TextBox cf10_SpellId;
		private TextBox cf10_FeatId;
		private CheckBox cf10_cheatCast;
		private Label cf10_spellId_label;
		private Label cf10_featId_label;
		private TextBox cf11_SpellId;
		private TextBox cf11_FeatId;
		private CheckBox cf11_cheatCast;
		private Label cf11_spellId_label;
		private Label cf11_featId_label;
		private CheckBox cf_HasFeatSpells;
		private Label cf_infoversion;
		private Label cf_infoversion_lbl;
		private ComboBox cbo_cf_Ability;
		private Label cf_Ability_lbl;
		private Label cf_BuffOthers_lbl;
		private ComboBox cbo_cf_BuffOthers;
		private ComboBox cbo_cf_Attack;
		private Label cf_Attack_lbl;
		private ComboBox cbo_cf_SpellProg;
		private Label cf_SpellProg_lbl;
		private ComboBox cbo_cf_SneakAttack;
		private Label cf_SneakAttack_lbl;
		private RadioButton cf_rbArcane;
		private RadioButton cf_rbDivine;
		private CheckBox cf_L4Required;
		private CheckBox cf_DcBonus;
		private CheckBox cf_isPrestigeClass;
		private ToolStripMenuItem pathClasses;
		private ToolStripMenuItem pathRacialSubtypes;
		private ToolStripSeparator toolStripSeparator4;
		private ToolStripMenuItem pathSpells;
		private ToolStripMenuItem pathFeat;
		private Label rf1_SpellLabel;
		private Label rf1_FeatLabel;
		private Label rf2_SpellLabel;
		private Label rf2_FeatLabel;
		private Label rf3_SpellLabel;
		private Label rf3_FeatLabel;
		private Label rf4_SpellLabel;
		private Label rf4_FeatLabel;
		private Label rf5_SpellLabel;
		private Label rf5_FeatLabel;
		private Label cf1_SpellLabel;
		private Label cf1_FeatLabel;
		private Label cf2_SpellLabel;
		private Label cf2_FeatLabel;
		private Label cf3_SpellLabel;
		private Label cf3_FeatLabel;
		private Label cf4_SpellLabel;
		private Label cf4_FeatLabel;
		private Label cf5_SpellLabel;
		private Label cf5_FeatLabel;
		private Label cf6_SpellLabel;
		private Label cf6_FeatLabel;
		private Label cf7_SpellLabel;
		private Label cf7_FeatLabel;
		private Label cf8_SpellLabel;
		private Label cf8_FeatLabel;
		private Label cf9_SpellLabel;
		private Label cf9_FeatLabel;
		private Label cf10_SpellLabel;
		private Label cf10_FeatLabel;
		private Label cf11_SpellLabel;
		private Label cf11_FeatLabel;
		private Label si_ChildLabel5;
		private Label si_ChildLabel4;
		private Label si_ChildLabel3;
		private Label si_ChildLabel2;
		private Label si_ChildLabel1;
		private Label si_infoversion;
		private Label si_infoversion_lbl;
		private ToolStripMenuItem applyGlobal;
		private ToolStripSeparator toolStripSeparator5;
		private Label si_ChildDc;
		private Label si_ChildSt;
		private Label si_ChildDi;
		private Label si_ChildEt;
		private Label si_ChildTi;
		...
		private void InitializeComponent()
		{
			...
			this.page_SpellInfo.Controls.Add(this.si_ChildLabel2);
			this.page_SpellInfo.Controls.Add(this.si_ChildLabel1);
