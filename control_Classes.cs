...
namespace nwn2_ai_2da_editor
{
		...
		: HenchControl
	{
		...
		/// <c><see cref="Class.differ">Class.differ</see></c> is tracked in
		/// each <c><see cref="Class"/></c> struct but is not saved to file.</remarks>
...
// handlers for Feats ->
		...
		/// <summary>
		/// Sets the master-int in <c><see cref="ClassFlags_text"/></c>.
		/// </summary>
